    ...
    public class CompanyJobEducationLogic : BaseLogic<CompanyJobEducationPoco>
    {
        ...
        protected override void Verify(CompanyJobEducationPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(200, $"Major for CompanyJobEducation {poco.Major} must be at least 2 characters long."));
                }
                if(poco.Importance<0)
                {
                    exceptions.Add(new ValidationException(201, $"Importance for CompanyJobEducation {poco.Importance} can not be less than zero."));
                }
             }
