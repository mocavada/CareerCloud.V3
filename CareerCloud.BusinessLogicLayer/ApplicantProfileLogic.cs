    ...
    public class ApplicantProfileLogic : BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(111, $"Current Salary for ApplicantProfile {poco.CurrentSalary} cannot be negative."));
                }
                if (poco.CurrentRate < 0)
                {
                    exceptions.Add(new ValidationException(112, $"Current Rate for ApplicantProfile {poco.CurrentRate} cannot be negative."));
                }
